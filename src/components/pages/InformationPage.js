    ...
    return(
        <div className={classes.container}>
            <div className={classes.top}>
                ...
                <section>
                    <p>This is just a <b>dummyStore</b>, I say the word "dummy" beacause it pulls data directly from a realtime database (Firebase). It's
                    only meant for a test, it was made with <b>React</b> and <b>Reduxjs</b>.
                    The branding is also an idea you might consider purchasing (winks) :). It's; 
                    <b> created for display and practice only.</b><br/></p>
